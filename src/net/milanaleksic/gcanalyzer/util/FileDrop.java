...
public class FileDrop {
    ...
    public FileDrop(
            @Nullable final java.io.PrintStream out,
            final java.awt.Component c,
            final javax.swing.border.Border dragBorder,
            final boolean recursive,
            final Listener listener) {
     ...
     *
     * @param out stream to write log to
     * @param evt event describing the drag
     * @return true if drag is ok
     */
     ...
     *
     * @param out     PrintStream where to route the logging message
     ...
     * @since 1.0
     */
    public static boolean remove(@Nullable java.io.PrintStream out, java.awt.Component c, boolean recursive) {   // Make sure we support dnd.
        if (supportsDnD()) {
