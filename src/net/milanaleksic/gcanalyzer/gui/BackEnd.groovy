    ...
    private JComponent createBasicStatisticsTable() {
        statisticsTable = new JTable(new AbstractTableModel() {
            ...
            private Object[][] data = [
                    ...
                    ['Average length of Young GC events', { String.format('%5.3f ms', gcLogInformationSource.averageYoungGCEventLength()) }],
                    ['Standard deviation of Young GC events', { String.format('%5.3f ms', gcLogInformationSource.standardDeviationYoungGCEventLength()) }],
                    ...
                    ['Average length of Full GC events', { String.format('%5.3f ms', gcLogInformationSource.averageFullGCEventLength()) }],
                    ['Standard deviation of Full GC events', { String.format('%5.3f ms', gcLogInformationSource.standardDeviationFullGCEventLength()) }],
